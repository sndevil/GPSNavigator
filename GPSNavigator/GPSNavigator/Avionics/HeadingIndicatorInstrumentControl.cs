...
namespace GPS
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        //GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources
        
        //Bitmap bmpCadran = new Bitmap(GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        //Bitmap bmpHedingWeel = new Bitmap(GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
        //Bitmap bmpAircaft = new Bitmap(GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);        
        Bitmap bmpCadran = new Bitmap(GPSNavigator.Properties.Resources.HeadingIndicator_Background1);
        Bitmap bmpHedingWeel = new Bitmap(GPSNavigator.Properties.Resources.HeadingWeel1);
        Bitmap bmpAircaft = new Bitmap(GPSNavigator.Properties.Resources.HeadingIndicator_Aircraft1);
