...
namespace GPS
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GPSNavigator.Properties.Resources.Horizon_Background1);// GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(GPSNavigator.Properties.Resources.Horizon_GroundSky1);// GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(GPSNavigator.Properties.Resources.Maquette_Avion1);// GPS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
